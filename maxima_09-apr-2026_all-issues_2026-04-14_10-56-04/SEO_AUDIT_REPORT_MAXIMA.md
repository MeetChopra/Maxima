...
| maxima-named-to-ai64...                    | Maxima announces $41M in funding to build an agentic AI platform for enterprise accounting...                                                    | OK (but same as above - possible duplication issue) | Maxima named to Redpoint's AI64 list of top enterprise AI apps — delivering up to 80% faster close cycles and 95% task automation.                | 129        |
| product-success-one-team                   | Learn why product and deployment or success teams need to be unified                                                                             | WEAK - too short and vague                          | Why Maxima merged product and deployment into one team — how unified incentives cut resolution times from months to days in accounting software.  | 143        |
